...
urllist = [{'site': u'https://freessr.xyz/',
           ...
           #         {'site': u'http://ss.ishadowx.com/',
           #       'csspath': u'#portfolio > div.container > div > div.portfolio-items > div.col-sm-6 > div.portfolio-item > div.hover-bg > div.hover-text',
           #       'remath': r'.*IP Address:<span id="[a-z]*">(.*)</span> <span class="copybtn" data-clipboard-target="#[A-Za-z].*"><i class="fa fa-copy"></i></span></h4><h4>Portï¼(\d*)</h4><h4>Password:<span id="[a-z]*">(.*)</span> <span class="copybtn" data-clipboard-target="#[a-z].*"><i class="fa fa-copy"></i></span></h4><h4>Method:(.*)</h4><h4>().*',
           #       'method': u'',
           #       },
